    ...
    <Container dir={i18n.dir()}>
      <Form onSubmit={handleSubmit(onSubmit)}>
        <Row className="mt-5">
          ...
          <h2>{t('addBookForm.addNewBook')}</h2>

            <Form.Group controlId="formTitle" className="mb-2">
            <Form.Label>{t('addBookForm.bookTitle')}</Form.Label>
              <Form.Control
                type="text"
            ...
            <Form.Label>{t('addBookForm.authorName')}</Form.Label>
              <Form.Control
                type="text"
            ...
            <Form.Group controlId="formAuthor" className="mb-2">
            <Form.Label>{t('addBookForm.bookRating')}</Form.Label>
              <Form.Control
                type="number"
                min={0}
                max={5}
            ...
            <Form.Label>{t('addBookForm.bookCategory')}</Form.Label>
              <Form.Control
                as="select"
                name="category"
            ...
            <Form.Label>{t('addBookForm.bookDescription')}</Form.Label>
              <Form.Control
                as="textarea"
                rows={4}
          ...
          <Col lg={6} md={12}>
            ...
            <Form.Label>{t('addBookForm.bookFile')}</Form.Label>
            ...
            <Form.Label>{t('addBookForm.coverImage')}</Form.Label>
              <div
