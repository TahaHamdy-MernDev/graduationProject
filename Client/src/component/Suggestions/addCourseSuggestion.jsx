...
const AddCourseSuggestion = () => {
  ...
  const onSubmit = (data) => {
    ...
    const updatedData = { ...restData,Suggestion:true, whatUWillLearn: whatYouWillLearn, image: coverImage, duration };
  ...
  return (
    <Container dir={i18n.dir()}>
      <Form className="form-suggestion-course" onSubmit={handleSubmit(onSubmit)}>
...
export default AddCourseSuggestion